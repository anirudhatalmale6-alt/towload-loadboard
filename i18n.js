...
es: {
  ...
  'nav.for_operators':   'Para empresas de grúas →',
  'nav.for_operators_f': 'Para empresas de grúas',
  'nav.how_it_works':    'Cómo funciona',
  'nav.need_tow':        'Necesito una grúa',
  'nav.support':         'Soporte',
  'nav.terms':           'Términos',
  ...
  'c.trying':            'Buscando…',
  'o.ht_earned':         'Usted ganó',
  'o.ht_billed':         'facturado',
  'o.ht_fee':            'comisión',
  'o.ht_paid':           'pagados',
  'o.ht_total':          'total',
  'o.ht_capped':         'Mostrando los {shown} más recientes de {total}. Los totales cubren los {total}.',
  'c.nocap_head':        'No podemos remolcar ese tamaño en su zona todavía',
  ...
  'pay.h':               'Último paso — autorice el pago',
  ...
  'c.confirm':           'Continuar al pago',
  'c.sending':           'Un momento…',
  ...
  'c.job_closed':        'Esa solicitud ya está cerrada.',
  'c.cancel_done':       'Su solicitud fue cancelada.',
  'c.cancel_confirm':    '¿Cancelar esta solicitud?',
  'c.cancel_fee':        'Cancelar — cargo de {amount}',
  'c.cancel_confirm_fee':'La grúa ya va en camino, así que se aplica un cargo de salida de {amount}. ¿Cancelar de todos modos?',
  'c.cancel_free_eta':   'Cancelar sin cargo',
  'c.cancel_confirm_eta':'El tiempo que prometió la grúa ya pasó, así que puede cancelar sin ningún cargo. ¿Cancelar?',
  'c.requeued':          'La grúa canceló el trabajo',
  'c.requeued_sub':      'Buscando otro conductor cerca de usted…',
  'c.charged':           'Cobrado',
  ...
  'c.map_no_driver':     'Buscando un conductor cerca de usted',

  /* operator board */
  'o.available_jobs':    'Trabajos disponibles',
  'status.awarded':      'Asignado',
  'status.en_route':     'En camino',
  'status.on_scene':     'En el lugar',
  'status.in_progress':  'Remolcando',
  'status.completed':    'Completado',
  'status.canceled':     'Cancelado',
  'status.expired':      'Vencido',
  'o.history':           'Historial',
  'o.hist_search_ph':    'Buscar nº, dirección, placa, cliente…',
  'o.hist_all':          'Todos los cerrados',
  'o.hist_goa':          'Vehículo ausente',
  'o.hist_from':         'Desde',
  'o.hist_to':           'Hasta',
  'o.hist_none':         'Nada que mostrar',
  'o.hist_none_sub':     'Los trabajos cerrados aparecen aquí. Pruebe con otra búsqueda o quite los filtros de fecha.',
  ...
  'o.miles_truck':       'millas de usted',
  'o.miles_yard':        'millas de su patio',
  'o.left':              'restante',
  ...
  'o.eta_honest':        'Ponga un tiempo honesto. Su cliente puede CANCELAR la llamada una vez que pase su ETA, y en ese caso no se cobra GOA.',
  'o.eta_1hr':           '1 hora',
  'o.mins':              '{n} min',
  'o.release':           'No puedo ir',
  'o.release_h':         'Devolver este trabajo',
  'o.release_why':       '¿Qué pasó? Su cliente no ve esto.',
  'o.release_note':      'El trabajo vuelve al tablero de inmediato y se avisa a otras empresas. Al cliente no se le cobra nada, y usted no podrá volver a tomar este trabajo.',
  'o.release_go':        'Devolver el trabajo',
  'o.release_loaded':    'El vehículo ya está cargado. Termine el trabajo o llame a soporte.',
  ...
  'o.ph_after':          'Al entregarlo',
  'o.ph_view':           'Toque la foto para verla en grande',
  'o.ph_taken':          'Tomada — toque para repetirla',
  'o.ph_damage':         'Daño ya existente',
  'o.ph_damage_h':       'Opcional. Tome todas las que quiera de golpes o rayones que ya traía.',
  'o.ph_saving':         'Guardando la foto…',
  'o.ph_failed':         'No se pudo guardar la foto. Inténtelo otra vez.',
  'o.ph_confirm':        'Faltan estas fotos: {missing}.\n\nSi el cliente reclama un daño, no tendrá con qué responder. Queda registrado que se le avisó.\n\n¿Terminar el trabajo de todos modos?',
  'o.flag_accident':     'Accidente',
  'o.flag_under':        'Subterráneo',
  'o.flag_ev':           'Eléctrico',
  'o.flag_flatbed':      'Plataforma',
  'o.pin_at':            'Ubicación GPS {coords}',
  'o.pin_unknown':       'Ubicación no indicada',
...
en: {
  ...
  'nav.for_operators':   'For tow companies →',
  'nav.for_operators_f': 'For tow companies',
  'nav.how_it_works':    'How it works',
  'nav.need_tow':        'Need a tow',
  'nav.support':         'Support',
  'nav.terms':           'Terms',
  ...
  'c.trying':            'Checking…',
  'o.ht_earned':         'You earned',
  'o.ht_billed':         'billed',
  'o.ht_fee':            'platform fee',
  'o.ht_paid':           'paid jobs',
  'o.ht_total':          'total',
  'o.ht_capped':         'Showing the most recent {shown} of {total}. The totals cover all {total}.',
  'c.nocap_head':        'We cannot tow that size here yet',
  ...
  'pay.h':               'Last step — authorize payment',
  ...
  'c.confirm':           'Continue to payment',
  'c.sending':           'One moment…',
  ...
  'c.job_closed':        'That request is already closed.',
  'c.cancel_done':       'Your request was canceled.',
  'c.cancel_confirm':    'Cancel this request?',
  'c.cancel_fee':        'Cancel — {amount} fee',
  'c.cancel_confirm_fee':'A driver is already on the way, so a {amount} call-out fee applies. Cancel anyway?',
  'c.cancel_free_eta':   'Cancel free of charge',
  'c.cancel_confirm_eta':'The ETA the towing company promised has passed, so you can cancel at no charge. Cancel this request?',
  'c.requeued':          'The towing company cancelled',
  'c.requeued_sub':      'Finding you another driver nearby…',
  'c.charged':           'Charged',
  'c.map_min':           'min away',
  ...
  'c.map_no_driver':     'Looking for a driver near you',

  'o.available_jobs':    'Available jobs',
  'status.awarded':      'Assigned',
  'status.en_route':     'On the way',
  'status.on_scene':     'On scene',
  'status.in_progress':  'Towing',
  'status.completed':    'Completed',
  'status.canceled':     'Canceled',
  'status.expired':      'Expired',
  'o.history':           'History',
  'o.hist_search_ph':    'Search number, address, plate, customer…',
  'o.hist_all':          'All closed jobs',
  'o.hist_goa':          'Vehicle gone',
  'o.hist_from':         'From',
  'o.hist_to':           'To',
  'o.hist_none':         'Nothing to show',
  'o.hist_none_sub':     'Closed jobs appear here. Try another search, or clear the date filters.',
  'o.my_jobs':           'My jobs',
  ...
  'o.accept':            'Accept',
  'o.miles':             'miles away',
  'o.miles_truck':       'miles from you',
  'o.miles_yard':        'miles from your yard',
  'o.left':              'left',
  ...
  'o.eta_honest':        'Specify honest ETA times. Your customer is allowed to CANCEL the call after your ETA has passed, and a GOA will not be charged.',
  'o.eta_1hr':           '1 hr',
  'o.mins':              '{n} min',
  'o.release':           'I cannot go',
  'o.release_h':         'Hand this job back',
  'o.release_why':       'What happened? Your customer does not see this.',
  'o.release_note':      'The job goes straight back on the board and other companies are alerted. The customer is charged nothing, and you will not be able to take this job again.',
  'o.release_go':        'Hand the job back',
  'o.release_loaded':    'The vehicle is already loaded. Finish the job or call support.',
  ...
  'o.ph_after':          'At drop-off',
  'o.ph_view':           'Tap the photo to see it full size',
  'o.ph_taken':          'Taken — tap to retake',
  'o.ph_damage':         'Existing damage',
  'o.ph_damage_h':       'Optional. Take as many as you like of dents or scratches already on it.',
  'o.ph_saving':         'Saving photo…',
  'o.ph_failed':         'Could not save that photo. Try again.',
  'o.ph_confirm':        'These photos are missing: {missing}.\n\nIf the customer claims damage you will have nothing to answer with. It is recorded that you were warned.\n\nFinish the job anyway?',
  'o.flag_accident':     'Accident',
  'o.flag_under':        'Underground',
  'o.flag_ev':           'EV',
  'o.flag_flatbed':      'Flatbed',
  'o.pin_at':            'GPS location {coords}',
  'o.pin_unknown':       'No location given',
  'o.mi_tow':            '{n} mi tow',
