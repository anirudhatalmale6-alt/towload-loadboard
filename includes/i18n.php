...
/* ── Withdrawals ───────────────────────────────────────────────── */
        ...
        'ok.withdrawal_partial' => 'Enviamos ${sent} a su banco. ${held} no se pudo enviar ({n} trabajo(s)) y sigue en su saldo disponible. Motivo: {reason}',
        'err.wd_check_failed'   => 'No pudimos confirmar con Stripe si este pago ya se había enviado, así que no lo reenviamos.',
        'money.job_removed'     => 'Trabajo eliminado',
        ...
        'err.logo_type'         => 'El logo debe ser JPG, PNG o WEBP.',
        'err.logo_too_big'      => 'El logo no puede pasar de :mb MB.',
        'err.logo_unreadable'   => 'No pudimos leer esa imagen. Pruebe con otra.',
        'err.logo_dimensions'   => 'Esa imagen es demasiado grande. Máximo 6000 x 6000 píxeles.',
        'ok.logo_saved'         => 'Logo guardado',
        'ok.logo_removed'       => 'Logo eliminado',
...
/* ── Withdrawals ───────────────────────────────────────────────── */
        ...
        'ok.withdrawal_partial' => 'Sent ${sent} to your bank. ${held} could not be sent ({n} job(s)) and is still in your available balance. Reason: {reason}',
        'err.wd_check_failed'   => 'We could not confirm with Stripe whether this payout had already been sent, so we did not send it again.',
        'money.job_removed'     => 'Job removed',
        ...
        'err.logo_type'         => 'Your logo must be a JPG, PNG or WEBP.',
        'err.logo_too_big'      => 'A logo cannot be larger than :mb MB.',
        'err.logo_unreadable'   => 'We could not read that image. Try another one.',
        'err.logo_dimensions'   => 'That image is too large. 6000 x 6000 pixels maximum.',
        'ok.logo_saved'         => 'Logo saved',
        'ok.logo_removed'       => 'Logo removed',
