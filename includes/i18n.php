...
function i18nCatalogue(): array {
    ...
    'es' => [
        ...
        /* ── Verification: documents, email, phone ─────────────────────── */
/* ── Ratings + fleet ───────────────────────────────────────────── */
        'err.rating_range'        => 'La calificación debe ser de 1 a 5 estrellas.',
        'err.rating_no_tower'     => 'Este trabajo no tiene una compañía asignada.',
        'err.rating_closed'       => 'El plazo para calificar este trabajo ya pasó.',
        'err.rating_failed'       => 'No pudimos guardar su calificación. Intente de nuevo.',
...
/* ── Account lifecycle + support ───────────────────────────────── */
        'err.del_live_jobs'       => 'Tiene {n} trabajo(s) sin terminar. Hay que cerrarlos primero.',
        'err.del_pending_payout'  => 'Todavía se le deben ${amount} sin pagar.',
        'err.del_balance'         => 'Tiene un saldo de ${amount} sin retirar.',
        'err.del_held'            => 'Hay ${amount} retenidos contra trabajos abiertos.',
        'err.del_disputes'        => 'Hay {n} disputa(s) abierta(s).',
        'err.delete_failed'       => 'No pudimos completar la eliminación. No se borró nada.',
        'err.account_closed_permanently' => 'Esta cuenta ya fue cerrada de forma permanente.',
        'err.disable_reason_required'    => 'Escriba el motivo de la suspensión.',
        'err.confirm_name_mismatch'      => 'Para confirmar, escriba exactamente: {name}',
        'err.financial_history_ack'      => 'Esta cuenta tiene {jobs} trabajo(s) completado(s) y {ledger} movimiento(s) contables. Borrarlos elimina ese historial de forma permanente. Confirme que lo entiende.',
        'err.type_delete'         => 'Escriba BORRAR para confirmar.',
        'err.not_your_account'    => 'Ese enlace no corresponde a esta cuenta.',
        'err.account_disabled_reason' => 'Su cuenta está suspendida. Motivo: {reason}',
        'msg.account_closed'      => 'Cuenta cerrada a pedido del titular.',
        'ok.account_closed'       => 'Su cuenta fue cerrada.',
        'ok.account_deleted'      => 'Cuenta eliminada por completo.',
        'ok.account_anonymized'   => 'Cuenta cerrada y datos personales eliminados.',
        'ok.account_disabled'     => 'Cuenta suspendida.',
        'ok.account_enabled'      => 'Cuenta reactivada.',

        'err.support_off'         => 'El soporte no está disponible en este momento.',
        'err.support_subject'     => 'Escriba un asunto.',
        'err.support_message'     => 'Escriba su mensaje.',
        'err.support_email'       => 'Escriba un correo válido para poder responderle.',
        'err.support_failed'      => 'No pudimos registrar su solicitud. Intente de nuevo.',
        'err.ticket_not_found'    => 'No encontramos esa solicitud.',
        'ok.support_sent'         => 'Recibimos su solicitud. Su número es {ref}.',
        'ok.reply_sent'           => 'Respuesta enviada.',
...
/* ── Withdrawals ───────────────────────────────────────────────── */
        ...
        'err.wd_nothing'        => 'No tiene saldo disponible para retirar.',
        'err.wd_failed'         => 'No pudimos procesar el retiro. No se movió dinero.',
        'err.wd_stripe'         => 'El banco rechazó el envío: {msg}',
        'ok.withdrawal_sent'    => 'Enviamos ${amount} a su banco.',
        'err.pf_payout_off'     => 'Los retiros de la plataforma están desactivados.',
        'err.pf_amount'         => 'Escriba un monto válido.',
        'err.pf_no_stripe'      => 'Stripe no está configurado todavía.',
        'err.pf_too_much'       => 'Solo puede retirar ${max}. El resto (${owed}) es dinero de las compañías de grúa y de trabajos en curso.',
        'ok.payout_queued'      => 'Retiro de ${amount} enviado a su banco.',

        'v.step_docs'             => 'Documentos de la compañía',
        'v.step_email'            => 'Correo electrónico',
        'v.step_phone'            => 'Número de teléfono',
        'v.docs_missing'          => 'Faltan documentos por subir.',
        'v.docs_pending'          => 'Recibimos sus documentos, están en revisión.',
        'v.docs_rejected'         => 'Uno de sus documentos fue rechazado. Revíselo y vuelva a subirlo.',
        'v.docs_expired'          => 'Su certificado de seguro está vencido. Suba uno vigente.',
        'v.docs_approved'         => 'Documentos aprobados.',
        'v.email_todo'            => 'Confirme su correo electrónico.',
        'v.email_done'            => 'Correo confirmado.',
        'v.phone_todo'            => 'Confirme su número de teléfono.',
        'v.phone_done'            => 'Teléfono confirmado.',

        'sms.code'                => 'TowSling: su código de verificación es {code}. Vence en {mins} minutos.',
        'mail.code_subject'       => 'Su código de TowSling: {code}',
        'mail.code_body'          => "Su código de verificación de TowSling es:\n\n    {code}\n\nEscríbalo en la página de su compañía para confirmar su correo electrónico. El código vence en {mins} minutos.\n\nSi usted no lo pidió, puede ignorar este mensaje.\n\n— TowSling",

        'err.bad_channel'         => 'Canal de verificación desconocido.',
        'err.no_email_on_file'    => 'No hay un correo electrónico en su cuenta.',
        'err.no_phone_on_file'    => 'No hay un número de teléfono en su cuenta. Agréguelo en los datos de su compañía.',
        'err.sms_unavailable'     => 'El envío de mensajes de texto todavía no está disponible. Confirme su correo mientras tanto.',
        'err.too_many_codes'      => 'Demasiados códigos enviados. Espere una hora antes de pedir otro.',
        'err.code_required'       => 'Escriba el código que recibió.',
        'err.code_none'           => 'No hay ningún código pendiente. Pida uno nuevo.',
        'err.code_expired'        => 'Ese código venció. Pida uno nuevo.',
        'err.code_burned'         => 'Demasiados intentos con ese código. Pida uno nuevo.',
        'err.code_wrong'          => 'Código incorrecto. Le quedan {n} intentos.',
        'err.destination_changed' => 'Sus datos cambiaron desde que pedimos el código. Pida uno nuevo.',
        'err.send_failed_email'   => 'No pudimos enviar el correo. Intente de nuevo en unos minutos.',
        'err.send_failed_phone'   => 'No pudimos enviar el mensaje de texto. Intente de nuevo en unos minutos.',
        'err.account_not_found'   => 'No encontramos la cuenta.',
        'ok.code_sent_email'      => 'Le enviamos un código a su correo.',
        'ok.code_sent_phone'      => 'Le enviamos un código por mensaje de texto.',
        'ok.verified_email'       => 'Correo confirmado.',
        'ok.verified_phone'       => 'Teléfono confirmado.',
        'ok.already_verified'     => 'Ya está confirmado.',
        ...
        // Fotos del trabajo
        'ph.corner_fl'            => 'Esquina delantera izquierda',
        'ph.corner_fl_h'          => 'De pie en la esquina, para ver el frente y el lado izquierdo a la vez.',
        'ph.corner_fr'            => 'Esquina delantera derecha',
        'ph.corner_fr_h'          => 'Mismo ángulo del otro lado.',
        'ph.corner_rr'            => 'Esquina trasera derecha',
        'ph.corner_rr_h'          => 'Para ver el lado derecho y la parte trasera.',
        'ph.corner_rl'            => 'Esquina trasera izquierda',
        'ph.corner_rl_h'          => 'Cierra la vuelta al vehículo.',
        'ph.plate'                => 'Placa',
        'ph.plate_h'              => 'Que se lea el número completo.',
        'ph.vin'                  => 'Número VIN',
        'ph.vin_h'                => 'En el tablero por el parabrisas, o en el marco de la puerta.',
        'ph.dropoff'              => 'Entrega',
        'ph.dropoff_h'            => 'El vehículo ya bajado en el destino.',
        'ph.type_damage'          => 'Daño',
        'ph.type_hookup'          => 'Enganche',
        'ph.type_arrival'         => 'Llegada',
        'ph.type_goa'             => 'Espacio vacío — vehículo ausente',
        'err.geocode_none'        => 'No encontramos esa dirección. Elíjala de la lista de sugerencias.',
        'ph.type_other'           => 'Otra foto',
        'ok.photo_saved'          => 'Foto guardada',
        'err.photo_type'          => 'Ese tipo de foto no existe.',
        ...
        // Pago — la retención de la tarjeta
        'err.pay_no_intent'       => 'No pudimos preparar el pago de esa solicitud. Por favor inténtelo de nuevo.',
        'err.pay_check_failed'    => 'No pudimos confirmar su pago con el banco. No se le ha cobrado nada. Por favor inténtelo de nuevo en un momento.',
        'err.pay_not_held'        => 'Su tarjeta aún no ha sido autorizada ({status}). Por favor complete el pago para que enviemos una grúa.',
        'err.pay_amount_mismatch' => 'El importe cambió mientras pagaba. No se le ha cobrado nada — por favor solicite la grúa de nuevo.',
        'pay.h'                   => 'Autorice el pago',
        'pay.sub'                 => 'Retenemos {amount} en su tarjeta. No se cobra nada hasta que la grúa termine el trabajo.',
        'pay.hold_note'           => 'Esto es una retención, no un cargo. Si nadie acepta el trabajo, la retención se libera sola.',
        ...
        // consumer status
        'status.draft'            => 'Esperando el pago',
    ...
    'en' => [
        ...
        /* ── Verification: documents, email, phone ─────────────────────── */
/* ── Ratings + fleet ───────────────────────────────────────────── */
        'err.rating_range'        => 'A rating has to be between 1 and 5 stars.',
        'err.rating_no_tower'     => 'This job has no towing company on it.',
        'err.rating_closed'       => 'The window for rating this job has closed.',
        'err.rating_failed'       => "We couldn't save your rating. Please try again.",
...
/* ── Account lifecycle + support ───────────────────────────────── */
        'err.del_live_jobs'       => 'There are {n} unfinished job(s). Those have to be closed first.',
        'err.del_pending_payout'  => 'There is still ${amount} owed and unpaid.',
        'err.del_balance'         => 'There is a balance of ${amount} that has not been withdrawn.',
        'err.del_held'            => 'There is ${amount} held against open jobs.',
        'err.del_disputes'        => 'There are {n} open dispute(s).',
        'err.delete_failed'       => 'We could not complete the deletion. Nothing was removed.',
        'err.account_closed_permanently' => 'This account has already been closed permanently.',
        'err.disable_reason_required'    => 'Give a reason for the suspension.',
        'err.confirm_name_mismatch'      => 'To confirm, type the name exactly: {name}',
        'err.financial_history_ack'      => 'This account has {jobs} completed job(s) and {ledger} accounting entr(ies). Deleting them removes that history permanently. Confirm you understand.',
        'err.type_delete'         => 'Type DELETE to confirm.',
        'err.not_your_account'    => 'That link does not belong to this account.',
        'err.account_disabled_reason' => 'Your account is suspended. Reason: {reason}',
        'msg.account_closed'      => 'Account closed at the owner\'s request.',
        'ok.account_closed'       => 'Your account has been closed.',
        'ok.account_deleted'      => 'Account deleted completely.',
        'ok.account_anonymized'   => 'Account closed and personal details removed.',
        'ok.account_disabled'     => 'Account suspended.',
        'ok.account_enabled'      => 'Account re-enabled.',

        'err.support_off'         => 'Support is not available right now.',
        'err.support_subject'     => 'Give your message a subject.',
        'err.support_message'     => 'Write your message.',
        'err.support_email'       => 'Give a valid email address so we can reply.',
        'err.support_failed'      => 'We could not log your request. Please try again.',
        'err.ticket_not_found'    => 'We could not find that request.',
        'ok.support_sent'         => 'We have your request. Your reference is {ref}.',
        'ok.reply_sent'           => 'Reply sent.',
...
/* ── Withdrawals ───────────────────────────────────────────────── */
        ...
        'err.wd_nothing'        => 'There is no available balance to withdraw.',
        'err.wd_failed'         => 'We could not process the withdrawal. No money was moved.',
        'err.wd_stripe'         => 'The transfer was refused: {msg}',
        'ok.withdrawal_sent'    => 'Sent ${amount} to your bank.',
        'err.pf_payout_off'     => 'Platform withdrawals are switched off.',
        'err.pf_amount'         => 'Enter a valid amount.',
        'err.pf_no_stripe'      => 'Stripe is not set up yet.',
        'err.pf_too_much'       => 'You can only withdraw ${max}. The rest (${owed}) is money owed to towing companies and jobs still running.',
        'ok.payout_queued'      => 'Withdrawal of ${amount} sent to your bank.',

        'v.step_docs'             => 'Company documents',
        'v.step_email'            => 'Email address',
        'v.step_phone'            => 'Phone number',
        'v.docs_missing'          => 'Some documents still need uploading.',
        'v.docs_pending'          => "We've received your documents, they are under review.",
        'v.docs_rejected'         => 'One of your documents was sent back. Check it and upload it again.',
        'v.docs_expired'          => 'Your insurance certificate has expired. Upload a current one.',
        'v.docs_approved'         => 'Documents approved.',
        'v.email_todo'            => 'Confirm your email address.',
        'v.email_done'            => 'Email confirmed.',
        'v.phone_todo'            => 'Confirm your phone number.',
        'v.phone_done'            => 'Phone confirmed.',

        'sms.code'                => 'TowSling: your verification code is {code}. It expires in {mins} minutes.',
        'mail.code_subject'       => 'Your TowSling code: {code}',
        'mail.code_body'          => "Your TowSling verification code is:\n\n    {code}\n\nEnter it on your company page to confirm your email address. The code expires in {mins} minutes.\n\nIf you didn't ask for this, you can ignore this message.\n\n- TowSling",

        'err.bad_channel'         => 'Unknown verification channel.',
        'err.no_email_on_file'    => 'There is no email address on your account.',
        'err.no_phone_on_file'    => 'There is no phone number on your account. Add one in your company details.',
        'err.sms_unavailable'     => 'Text messages are not switched on yet. Confirm your email in the meantime.',
        'err.too_many_codes'      => 'Too many codes sent. Wait an hour before asking for another.',
        'err.code_required'       => 'Enter the code you were sent.',
        'err.code_none'           => 'There is no code waiting. Ask for a new one.',
        'err.code_expired'        => 'That code has expired. Ask for a new one.',
        'err.code_burned'         => 'Too many tries on that code. Ask for a new one.',
        'err.code_wrong'          => 'Wrong code. {n} tries left.',
        'err.destination_changed' => 'Your details changed since we sent the code. Ask for a new one.',
        'err.send_failed_email'   => "We couldn't send the email. Try again in a few minutes.",
        'err.send_failed_phone'   => "We couldn't send the text. Try again in a few minutes.",
        'err.account_not_found'   => 'We could not find that account.',
        'ok.code_sent_email'      => 'We sent a code to your email.',
        'ok.code_sent_phone'      => 'We sent you a code by text.',
        'ok.verified_email'       => 'Email confirmed.',
        'ok.verified_phone'       => 'Phone confirmed.',
        'ok.already_verified'     => 'Already confirmed.',
        ...
        // Job photos
        'ph.corner_fl'            => 'Front left corner',
        'ph.corner_fl_h'          => 'Stand at the corner so the front and the left side are both in shot.',
        'ph.corner_fr'            => 'Front right corner',
        'ph.corner_fr_h'          => 'Same angle from the other side.',
        'ph.corner_rr'            => 'Rear right corner',
        'ph.corner_rr_h'          => 'Catches the right side and the back.',
        'ph.corner_rl'            => 'Rear left corner',
        'ph.corner_rl_h'          => 'Closes the walk around the vehicle.',
        'ph.plate'                => 'Number plate',
        'ph.plate_h'              => 'Close enough to read every character.',
        'ph.vin'                  => 'VIN number',
        'ph.vin_h'                => 'On the dash through the windscreen, or in the door frame.',
        'ph.dropoff'              => 'Drop-off',
        'ph.dropoff_h'            => 'The vehicle unloaded at the destination.',
        'ph.type_damage'          => 'Damage',
        'ph.type_hookup'          => 'Hook-up',
        'ph.type_arrival'         => 'Arrival',
        'ph.type_goa'             => 'Empty space — vehicle gone',
        'err.geocode_none'        => 'We could not find that address. Pick it from the suggestions.',
        'ph.type_other'           => 'Other photo',
        'ok.photo_saved'          => 'Photo saved',
        'err.photo_type'          => 'That is not a photo type we know.',
        ...
        // Payment — the card hold
        'err.pay_no_intent'       => 'We could not set up payment for that request. Please try again.',
        'err.pay_check_failed'    => 'We could not confirm your payment with the bank. Nothing has been charged. Please try again in a moment.',
        'err.pay_not_held'        => 'Your card has not been authorized yet ({status}). Please complete payment so we can send a truck.',
        'err.pay_amount_mismatch' => 'The price changed while you were paying. Nothing has been charged — please request the tow again.',
        ...
        'status.draft'            => 'Waiting for payment',
